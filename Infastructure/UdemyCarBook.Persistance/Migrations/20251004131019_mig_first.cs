    ...
    public partial class mig_first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarFetures", x => x.CarFeatureID);
                    table.ForeignKey(
                        name: "FK_CarFetures_Cars_CarID",
                        column: x => x.CarID,
                        principalTable: "Cars",
                        principalColumn: "CarID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarFetures_Features_FeatureID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarFetures_CarID",
                table: "CarFetures",
                column: "CarID");

            migrationBuilder.CreateIndex(
                name: "IX_CarFetures_FeatureID",
                table: "CarFetures",
                column: "FeatureID");
